...
function ProfileScreen({ items }: { items: ClothingItem[] }) {
  ...
  return (
    <div className="px-5 pt-14 pb-28 lg:px-10 lg:pt-10 lg:pb-10">
      <h1 className="text-2xl lg:text-3xl font-bold text-foreground tracking-tight mb-1">Profile</h1>
      ...
      <div className="flex flex-col items-center mb-7 lg:mb-10">
        ...
        <h2 className="text-lg lg:text-xl font-bold text-foreground">Recount User</h2>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 mb-5 lg:mb-8">
        <div className="bg-card rounded-2xl p-4 lg:p-6 shadow-sm border border-border text-center">
          <p className="text-2xl lg:text-3xl font-bold text-primary font-mono">{items.length}</p>
          <p className="text-[10px] lg:text-xs text-muted-foreground font-medium uppercase tracking-wider mt-1">
            Items
          </p>
        </div>
        <div className="bg-card rounded-2xl p-4 lg:p-6 shadow-sm border border-border text-center">
          <p className="text-2xl lg:text-3xl font-bold text-primary font-mono">{totalWears}</p>
          <p className="text-[10px] lg:text-xs text-muted-foreground font-medium uppercase tracking-wider mt-1">
            Total Wears
          </p>
        </div>
        <div className="bg-card rounded-2xl p-4 lg:p-6 shadow-sm border border-border text-center">
          <p className="text-2xl lg:text-3xl font-bold text-foreground font-mono">${totalValue.toFixed(0)}</p>
          <p className="text-[10px] lg:text-xs text-muted-foreground font-medium uppercase tracking-wider mt-1">
            Wardrobe Value
          </p>
        </div>
        <div className="bg-card rounded-2xl p-4 lg:p-6 shadow-sm border border-border text-center">
          <p className="text-2xl lg:text-3xl font-bold text-foreground font-mono">${avgCostPerWear.toFixed(2)}</p>
          <p className="text-[10px] lg:text-xs text-muted-foreground font-medium uppercase tracking-wider mt-1">
            Avg Cost/Wear
          </p>
        </div>
      ...
      <div className="bg-card rounded-2xl p-4 lg:p-6 shadow-sm border border-border space-y-3 max-w-xl">
        <h3 className="text-sm lg:text-base font-semibold text-foreground">Quick Actions</h3>
        {[
          ...
          >
            <div>
              ...
              <p className="text-[10px] lg:text-xs text-muted-foreground">{action.desc}</p>
            </div>
            <svg
