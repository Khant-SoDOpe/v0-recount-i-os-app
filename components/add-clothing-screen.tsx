  ...
  return (
    <div className="px-5 pt-14 pb-28">
      ...
      <div className="flex items-center gap-3 mb-7">
        ...
        <h1 className="text-xl font-bold text-foreground tracking-tight">Add Clothing</h1>
      </div>

      {/* Image Picker */}
      <button className="w-full aspect-[4/3] rounded-2xl bg-card border-2 border-dashed border-border flex flex-col items-center justify-center gap-3 mb-6 active:bg-secondary transition-colors">
      ...
      <button
        onClick={handleSave}
        disabled={!name.trim()}
        className="w-full mt-7 py-4 rounded-2xl bg-primary text-primary-foreground font-semibold text-base shadow-lg shadow-primary/30 active:scale-[0.98] transition-transform disabled:opacity-40 disabled:shadow-none disabled:active:scale-100"
      >
        Save Item
      </button>
    </div>
